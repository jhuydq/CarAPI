...
class CarController {
    ...
    Resource<Car> get(@PathVariable Long id) {
        ...
        try{
            ...
            /** FIXME:
             * I don't understand the way of handling error from ErrorController
             * It seems to me that we shouldn't catch the exception here because ErrorController will catch
             * and handle it. Right?
             */
            e.printStackTrace();
            throw e;
